        ...
        for i = 1:size(allDataIndexChange,1)+1
            if i == r+1
                ...
                result{count,2} = data{allDataIndexChange{r,1},2};
                 ...
                 if i == 1
                    result{count,1} = data{allDataIndexChange{i+1,1}-1,2};
                    result{count,2} = data{allDataIndexChange{i,1},2};%data{2,2};
                    count = count + 1;
                else
                    result{count,1} = data{allDataIndexChange{i,1},2};
